...
def proposal_target_layer(rpn_rois, rpn_scores, gt_boxes, _num_classes):
  ...
  num_images = 1
  rois_per_image = rpn_rois.shape[0] / num_images
...
def _sample_rois(all_rois, all_scores, gt_boxes, fg_rois_per_image, rois_per_image, num_classes):
  ...
  bg_inds = (max_overlaps < cfg.TRAIN.FG_THRESH).nonzero().view(-1)
  ...
  labels[bg_inds] = 0
  rois = all_rois.contiguous()
  roi_scores = all_scores.contiguous()
