  ...
  def train_model(self, max_iters):
    ...
    while iter < max_iters + 1:
      ...
      if iter == 1 or now - last_summary_time > cfg.TRAIN.SUMMARY_INTERVAL:
        ...
        cls_det_loss, refine_loss_1, refine_loss_2, refine_loss_3, rotate_loss, loss_box, total_loss, summary = \
        ...
        cls_det_loss, refine_loss_1, refine_loss_2, refine_loss_3, rotate_loss, loss_box, total_loss = self.net.train_step(blobs, self.optimizer)
      ...
      if iter % (cfg.TRAIN.DISPLAY) == 0:
        print('iter: %d / %d, total loss: %.6f\n >>> cls_det_loss: %.6f\n '
              '>>> refine_loss_1: %.6f\n >>> refine_loss_2: %.6f\n >>> refine_loss_3: %.6f\n >>> rotate_loss: %.6f\n >>> loss_box: %.6f\n'
              '>>> lr: %f' % \
              (iter, max_iters, total_loss, cls_det_loss, refine_loss_1, refine_loss_2, refine_loss_3, rotate_loss, loss_box, lr))
